    ...
    <div class="w-10/12 grid grid-cols-3 gap-6 mx-auto justify-center">
        <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
            ...
            <div>
                ...
                <p class="text-gray-500 text-sm">Cho đơn 200k trở lên</p>
            </div>
        </div>
        <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
        ...
        <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
            ...
            <div>
                <h4 class="font-medium capitalize text-lg">Dịch vụ 24/7</h4>
                <p class="text-gray-500 text-sm">Hỗ trợ khách hàng</p>
            </div>
        </div>
    </div>
</div>
