    ...
    <div class="contain py-16">
        <div class="max-w-lg mx-auto shadow border px-6 py-7 rounded overflow-hidden bg-amber-100">
            ...
            <form action="{{ route('user.postChangePassword') }}" method="POST">
                ...
                <div class="mt-4">
                    <button class="block w-full py-2 text-center text-white border border-amber-500 rounded bg-amber-500 hover:bg-transparent hover:text-amber-500 transition uppercase font-roboto font-medium">Submit</button>
                </div>
