...
<div class="flex bg-amber-100 items-center py-3 w-full rounded text-sm text-gray-800">
    ...
    <a href="/products/{{ $item->product_id }}" class="flex w-3/5 items-center lg:w-3/5 max-w-sm max-w-md">
    ...
    <div class="flex justify-between items-center flex-1 ">
        ...
        @if($order_status == 5)
        <a href="/review/{{ $item->ordered_product_id }}" class="font-semibold text-red-500 text-center underline rounded hover:scale-105">Đánh giá</a>
        @endif
    </div>
</div>
